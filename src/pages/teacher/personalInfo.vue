        ...
        <div id="box">
            <el-form ref="user" :model="user" label-width="80px">
                ...
                <el-form-item label="职称：">
                    <el-input v-model="user.officeHolder"></el-input>
                </el-form-item>
...
export default {
    ...
    methods:{
        getInfo(){
            ...
            axios({
                method: 'get',
                url: this.$host+'/manage_platform/teacher'
            })
            .then(response => {
        ...
        EditInfo(){
            ...
            axios({
                method: 'post',
                url: this.$host+'/manage_platform/teacher_message',
                data:{
                    password:this.user.password,
                    telephone:this.user.telephone,
                    mail:this.user.mail,
                    officeHolder:this.user.officeHolder
                }
            })
            .then(response => {
                var data=response.data;
