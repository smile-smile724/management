...
<template>
    <div class="mainbox">
        <div id="pro">
            ...
            <!-- 弹窗 -->
            <el-dialog title="实验室审批" :visible.sync="dialogVisible">
                <div id="pro_Approval">
                    <div id="pro_table">
                        <el-form ref="form" :model="form" label-width="100px" id="form">
                            <el-form-item label="实验室名称:">
                                <span>{{form.labName}}</span>
                            </el-form-item>
...
export default {
    ...
    methods:{
        getInfo(){
            ...
            axios({
                method: 'get',
                url: this.$host+'/manage_platform/order_lab_query'
            })
            .then(response => {
        ...
        agreeApproval(){
            ...
            axios({
                method: 'post',
                url: this.$host+'/manage_platform/approval_lab',
                data:{
                    orderState:"同意审批",
                    id:this.form.id,
        ...
        getHistory(sta){
            axios({
                method: 'post',
                url: this.$host+'/manage_platform/lab_query_by_state',
                data:{
                    orderState:sta
                }
            })
