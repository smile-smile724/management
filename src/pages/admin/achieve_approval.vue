...
<template>
    <div class="mainbox">
        <div id="pro">
            ...
            <!-- 弹窗 -->
            <el-dialog title="成果审批" :visible.sync="dialogVisible">
                <div id="pro_Approval">
                    <div id="pro_table">
                        <el-form ref="form" :model="form" label-width="100px" id="form">
                            ...
                            <el-form-item label="实验成果:">
                                <a v-for="(item,index) in form.achievementFile" :href="item" :download="changeAddress(item)" :key="index">
                    ...
                    <div id="pro_box" v-if="choose!='未审批'&&dialogVisible">
                        <el-form ref="comment" :model="form" label-width="100px">
                            <el-form-item label="审批结果:">
                                <span>{{form.msg.state}}</span>
                            </el-form-item>
                            <el-form-item label="审批原因:">
                                <span style="width:100%;text-align:left">{{form.msg.reason}}</span>
                            </el-form-item>
                        </el-form>
                    </div>
                </div>
...
export default {
    ...
    methods:{
        getInfo(){
            ...
            axios({
                method: 'get',
                url: this.$host+'/manage_platform/project_achievement_approval_list'
            })
            .then(response => {
